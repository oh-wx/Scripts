...
class Menu:
	...
	def get_obs():
		...
		sector  = {'CP':'s14','SP':'s15','NE':'s16','EC':'s17','SE':'s18','US':'s19','MW':'s20'}
		hazard	= {'1':severe,
				   '2':winter,
				   'D':('DERCHO','dcp'),
				   'P':('PWAT','pwtr',True),
	...
	def get_twd():
		...
		URL = 'http://www.twisterdata.com/data/models/gfs/3/maps/2016/12/19/06/GFS_3_2016121906_F120_TMPF_2_M_ABOVE_GROUND.png'
			  ...
			  'http://www.twisterdata.com/data/models/nam/221/maps/{yr}/{mm}/{dd}/{ii}/NAM_221_{yyyymmddii}_F{hr}_{param}_{level}.png'
			  'http://www.twisterdata.com/data/models/gfs/3/maps/{yr}/{mm}/{dd}/{ii}/GFS_3_{yyyymmddii}_F{hr}_{param}_{level}.png'
			  'http://www.twisterdata.com/data/models/rap/255/maps/{yr}/{mm}/{dd}/{ii}/RAP_255_{yyyymmddii}_F{hr}_{param}_{level}.png'
	...
	def obs_menu():
		options = ['1','2','9','R','V','P','C','H','M','D','L','I']
